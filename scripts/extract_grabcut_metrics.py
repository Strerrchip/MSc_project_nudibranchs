...
def extract_metrics_for_image(image_path):
    ...
    mask_path = mask_dir / species_folder / f"{image_id}_animal_mask_grabcut.png"
    ring_path = ring_dir / species_folder / f"{image_id}_background_ring{RING_WIDTH}.png"
    ...
    row = {
        ...
        "image_id": image_id,
        "segmentation_method": "grabcut_baseline",
        ...
        "notes": "automatic GrabCut baseline; background ring generated by mask dilation",
    }
...
def main():
    ...
    print("Extracting image metrics from GrabCut ring80 masks...\n")
    ...
    output_path = metrics_dir / "grabcut_ring80_image_metrics_pilot.csv"
