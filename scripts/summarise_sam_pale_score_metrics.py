...
input_path = (
    PROJECT_DIR
    / "processed_data/automated_image_analysis/image_metrics/sam_pale_score_image_metrics_pilot.csv"
)

output_path = (
    PROJECT_DIR
    / "processed_data/automated_image_analysis/image_metrics/sam_pale_score_species_metrics_pilot.csv"
)
...
species_summary = metrics.groupby("species").agg(
    ...
    mean_animal_edge_density=("animal_edge_density", "mean"),
    sd_animal_edge_density=("animal_edge_density", "std"),
...
print("Saved species-level SAM pale-score metrics to:")
print(output_path)
